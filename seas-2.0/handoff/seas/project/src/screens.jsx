...
const PageHeader = ({ title, subtitle, step, totalSteps, onBack, onProceed, rightSlot }) => (
  <div style={{display:"flex", alignItems:"flex-end", justifyContent:"space-between", gap:16, padding:"18px 28px 14px", borderBottom:"1px solid var(--line)", background:"#fff"}}>
    <div>
...
const Stat = ({label, value, hint, accent, trend}) => (
  <div style={{padding:"12px 14px", border:"1px solid var(--line)", borderRadius:10, background:"#fff", minWidth:140, flex:1}}>
...
const Interpretation = ({ bullets, title="AI interpretation", action }) => (
  <div className="ai-border" style={{borderRadius:12, background:"linear-gradient(180deg,#fff,#fbf6ee)", padding:14}}>
    <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:8}}>
      <div style={{width:22, height:22, borderRadius:7, background:"#171715", color:"#f3c27a", display:"grid", placeItems:"center"}}>
  ...
  return (
    <div style={{padding:"28px 28px 40px", maxWidth:1200, margin:"0 auto"}}>
      ...
      <div style={{display:"grid", gridTemplateColumns:"1.6fr 1fr", gap:16, marginBottom:20}}>
        ...
        <div className="ai-border" style={{borderRadius:12, background:"linear-gradient(180deg,#fff,#fbf6ee)", padding:16}}>
          ...
          {[
            ...
            <button key={i} onClick={onStart} style={{display:"block", width:"100%", textAlign:"left", background:"#fff", border:"1px solid var(--line)", borderRadius:8, padding:"8px 10px", fontSize:12.5, color:"var(--ink)", marginBottom:6, cursor:"pointer"}}>
      ...
      {/* footer */}
      <div style={{fontSize:11.5, color:"var(--ink-4)", textAlign:"center"}}>SEAS 2.0 · AI-Medicine Lab · © 2026</div>
    </div>
  );
};
        ...
        <div style={{display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:12, marginBottom:18}}>
          {[
            ...
            <button key={t.id} onClick={()=>setMode(t.id)} style={{
              ...
              <div style={{display:"flex", alignItems:"center", gap:8}}>
                <div style={{width:26, height:26, borderRadius:8, background:"#fff", border:"1px solid var(--line)", display:"grid", placeItems:"center"}}>
        ...
        <div style={{display:"grid", gridTemplateColumns:"1.3fr 1fr", gap:14}}>
          <div className="card">
            ...
            <div style={{padding:"10px 16px", display:"flex", alignItems:"center", gap:10, borderBottom:"1px solid var(--line)", background:"var(--surface-2)"}}>
              <div style={{display:"flex", gap:0, border:"1px solid var(--line)", borderRadius:8, overflow:"hidden", background:"#fff"}}>
                <button className="btn sm ghost" style={{borderRadius:0, borderRight:"1px solid var(--line)", background: "#fff"}}>Feature set</button>
            ...
            {aiMapOpen && (
              <div className="fade-up" style={{padding:"10px 16px", background:"#fffaf0", borderBottom:"1px solid #f0d9a8", fontSize:12.5, color:"#6a3d0a"}}>
        ...
        <div className="card" style={{alignSelf:"flex-start"}}>
          ...
          <div style={{padding:"12px 14px", display:"flex", flexDirection:"column", gap:12}}>
            <div>
              ...
              <select value={c1} onChange={e=>setC1(e.target.value)} style={{width:"100%", padding:"8px 10px", border:"1px solid var(--line)", borderRadius:8, background:"#fff", fontSize:13}}>
            ...
            <div>
              ...
              <select value={c2} onChange={e=>setC2(e.target.value)} style={{width:"100%", padding:"8px 10px", border:"1px solid var(--line)", borderRadius:8, background:"#fff", fontSize:13}}>
                {clinotypes.map(c=><option key={c.name}>{c.name}</option>)}
              </select>
            </div>
          ...
          <div style={{padding:12, display:"flex", flexDirection:"column", gap:12}}>
            {method==="neighborhood" && <>
              <div>
                ...
                <select value={pivotId} onChange={e=>onPivot(e.target.value)} style={{width:"100%", marginTop:4, padding:"8px 10px", border:"1px solid var(--line)", borderRadius:8, background:"#fff", fontSize:12.5, fontFamily:"JetBrains Mono"}}>
        ...
        <div className="card" style={{alignSelf:"flex-start"}}>
          ...
          <div style={{padding:12, display:"flex", flexDirection:"column", gap:14}}>
            <div>
              ...
              <select style={{width:"100%", marginTop:4, padding:"8px 10px", border:"1px solid var(--line)", borderRadius:8, background:"#fff", fontSize:12.5}}>
                <option>All</option>
      ...
      <div style={{padding:"18px 28px", display:"grid", gridTemplateColumns:"1.6fr 1fr", gap:16}}>
        <div className="card">
          ...
          <div style={{padding:"18px 22px", maxWidth:720}}>
            ...
            <div style={{fontSize:12.5, color:"var(--ink-3)", marginBottom:18}}>Authors: Siddharth K. · Samuel Bharti · AI-Medicine Lab · Apr 21, 2026</div>
